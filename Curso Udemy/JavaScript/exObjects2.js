...
//console.log(name);
const { firstName, surname, age: idade } = pessoa; //atribuicao via desestruturacao, extrai do objeto pessoa a chave firstName e ja cria uma variavel com o nome dessa chave que neesse caso eh firstName
